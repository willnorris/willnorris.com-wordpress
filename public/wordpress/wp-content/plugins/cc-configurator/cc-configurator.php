...
function bccl_license_options () {
	...
	*/
	if (isset($_POST["options_update"])) {
		...
		*/
		$cc_settings = array(
			"license_url"	=> htmlspecialchars($_GET["license_url"]),
			"license_name"	=> htmlspecialchars($_GET["license_name"]),
			"license_button"=> htmlspecialchars($_GET["license_button"]),
			"deed_url"	=> htmlspecialchars($_GET["deed_url"]),
			"options"	=> array(
				"cc_creator"	=> "blogname",
				"cc_color"	=> "#000000",
				"cc_bgcolor"	=> "#eef6e6",
...
function bccl_get_license_image_hyperlink($button = "default") {
	...
	*/
	...
	$image_link_format = "<a rel=\"license\" href=\"%s\"><img alt=\"%s\" border=\"0\" src=\"%s\" class=\"cc-button\" /></a>";
